...
COLORREF WarmColor(BYTE red, BYTE green, BYTE blue) {
...
void Win32Window::UpdateTheme(HWND const window) {
  ...
  const COLORREF caption_color = enable_dark_mode
                                     ? WarmColor(31, 25, 23)
                                     : WarmColor(250, 244, 236);
  const COLORREF text_color = enable_dark_mode
                                  ? WarmColor(246, 238, 231)
                                  : WarmColor(58, 43, 30);
  const COLORREF border_color = enable_dark_mode
                                    ? WarmColor(88, 70, 61)
                                    : WarmColor(226, 204, 184);
